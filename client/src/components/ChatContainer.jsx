...
const ChatContainer = () => {
  ...
  return selectedUser ? (
      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
        {messages.map((msg, index) => {
          ...
          return (
            ...
            >
              {/* Receiver's profile on left */}
              {!isSender && (
                <div className="text-center text-xs">
                  <img src={profilePic} alt="" className="w-7 rounded-full" />
              ...
              {msg.image ? (
                <img
                  src={msg.image}
                  alt="sent image"
                  className="max-w-[230px] border border-gray-50-700 object-contain rounded-lg overflow-hidden"
                />
              ) : (
                <p
    ...
    >
      ...
      <p className="text-lh font-medium text-white"> chat anytime,Anywhere</p>
    </div>
  );
};
